...
function intro() {
    ...
    $choice = strtolower(readline("Do you want to enter the cave? (yes/no): "));
...
function enterCave() {
    ...
    $choice = strtolower(readline("Do you want to light a torch? (yes/no): "));
...
function lightTorch() {
    ...
    $choice = strtolower(readline("Do you want to explore further or leave? (explore/leave): "));
